      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Button variant="ghost" size="icon" aria-label="Ver carrito" className="border-2 border-foreground hover:bg-[#f633cc] hover:text-white">
              <ShoppingBag className="h-5 w-5" />
            </Button>
            <Button className="bg-[#53f921] hover:bg-[#4ae01d] text-foreground font-bold uppercase border-2 border-foreground comic-shadow hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all">
              Pedir Ahora
            </Button>
          </div>
